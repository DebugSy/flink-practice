...
public class CEPDataSource extends RichSourceFunction<Row> {
    ...
    public static String CLICK_FIELDS = "CDR_ID,USR_ID,USER_BRAND,ORD_STS,RCV_AMT,OFF_FLAG,POST_TM.rowtime";
    ...
    static {
        ...
        clicks.add(Arrays.asList("63", "user02", "brand16", "0", "99.90", "1", "2019-07-23 23:27:31.840"));
        ...
        clicks.add(Arrays.asList("68", "user04", "brand12", "0", "1.90",  "1", "2019-07-23 23:27:36.915"));
...
//        clicks.add(Arrays.asList("71", "user09", "brand19", "0", "58.90", "1", "2019-07-23 23:27:27.189"));//晚到数据
        ...
        clicks.add(Arrays.asList("74", "user04", "brand19", "0", "3.90",  "1", "2019-07-23 23:28:02.990"));
...
//        clicks.add(Arrays.asList("79", "user02", "brand16", "0", "63.90", "1", "2019-07-23 23:27:43.931"));//晚到数据
        clicks.add(Arrays.asList("80", "user01", "brand13", "2", "78.90", "1", "2019-07-23 23:28:20.000"));
    ...
    public void run(SourceContext<Row> sourceContext) throws Exception {
        ...
        while (iterator.hasNext()) {
            ...
            row.setField(5, Integer.parseInt(record.get(5)));
            row.setField(6, Timestamp.valueOf(record.get(6)));
